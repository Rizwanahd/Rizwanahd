...
ActiveRecord::Schema[7.0].define(version: 20_220_603_115_226) do
  ...
  create_table 'issues', force: :cascade do |t|
    ...
    t.index ['developer_id'], name: 'index_issues_on_developer_id'
    t.index ['project_id'], name: 'index_issues_on_project_id'
    t.index ['qa_id'], name: 'index_issues_on_qa_id'
  end
